...
responsive is fluid and adapts to the size of the screen no matter what the target device. Adaptive design uses static layouts based on breakpoints which don't respond once they're initially loaded.
